      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {!readOnly && (
          <button
            ...
            className={`shrink-0 rounded-xl px-3 py-2 font-display font-bold text-sm text-[#7097AB] transition-500 hover:scale-105 active:scale-95 bg-[#87CEEB] flex items-center gap-1.5`}
          >
