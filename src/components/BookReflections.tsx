      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {!readOnly && (
          <button
            ...
            className={`shrink-0 rounded-xl px-3 py-2 font-display font-bold text-sm text-[#710193] hover:scale-105 active:scale-95 bg-[#87CEEB] flex items-center gap-1.5`}
          >
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-xl px-3 py-2.5 text-sm font-semibold outline-none border ${
                    isSpace ? 'bg-slate-50 border-slate-600 text-black' : 'bg-slate-50 border-slate-200 text-slate-800'
