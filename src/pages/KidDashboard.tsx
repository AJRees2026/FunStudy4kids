      ...
      <header className={`sticky top-0 z-30 backdrop-blur-md border-b relative ${isSpace ? 'bg-[#1d173b]/60 border-white/10' : 'bg-black/20 border-white/5'}`}>
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12.5 h-12.5 rounded-full bg-gradient-to-br from-indigo-500 to-teal-500 flex items-center justify-center text-xl shadow-lg overflow-hidden">
