      ...
      <header className={`sticky top-0 z-30 backdrop-blur-md border-b relative ${isSpace ? 'bg-[#1d173b]/60 border-white/10' : 'bg-black/20 border-white/5'}`}>
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-teal-500 flex items-center justify-center text-xl shadow-lg overflow-hidden">
            ...
            <div>
              <p className={`font-display font-bold ${isSpace ? 'text-white' : theme.textPrimary} text-lg leading-none flex items-center gap-2`}>
                ...
                {currentChild.writing_rank && ['master_storyteller', 'master_wordsmith', 'grand_chronicler', 'epic_author'].includes(currentChild.writing_rank) && (
                  <span className="inline-flex items-center gap-0.5 text-sm font-bold rounded-full bg-gradient-to-r from-amber-400 to-orange-500 text-white px-2 py-0.5 shadow-sm">
          ...
          <section className="animate-fadeIn">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <p className={`text-lg font-semibold text-[#4169e1] leading-snug`}>{t('moodTrackerDesc')}</p>
...
<h3 className="sparkle-title font-display font-extrabold text-xl mb-1">
  {t('rewardShop')}
</h3>
