  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 pb-20">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 gap-x-1 gap-y-4 justify-items-center py-2">
          {navBadges.map((badge, i) => {
            ...
            return (
              ...
              >
                <div className={`w-28 h-28 md:w-30 md:h-30 rounded-full bg-white border-4 ${badge.border} ${badge.shadow} flex flex-col items-center justify-center p-1.5 text-center transition-all ${isActive ? 'ring-4 ring-offset-2 ring-indigo-300 bg-indigo-50/50' : ''} ${badge.blink ? 'animate-blink' : ''}`}>
                  <div className={`w-7 h-7 rounded-full ${badge.iconBg} flex items-center justify-top mb-0.5`}>
