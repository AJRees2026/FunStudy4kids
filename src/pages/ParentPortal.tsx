          ...
          {tabs.filter((tb) => tb.id === 'overview').map((tb) => {
            ...
            return (
              <button
                ...
                className={`group relative w-full rounded-2xl p-4 shadow-md hover:shadow-xl transition-all hover:scale-[1.02] active:scale-95 text-left text-sm font-display flex items-center gap-3 ${
                  isActive
